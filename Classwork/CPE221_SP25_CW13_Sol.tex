...
\newcommand{\hw}{Classwork 13: Machine Code in ARM}
...
\section{Encode STRB \hfill (10 Points)}

\texttt{STRB R10, [R6, \#40]!}
...
\begin{tcolorbox}[
    ...
    \begin{itemize}
        \item Load word into R10, L = 0, B = 1 (Byte)
        \item Base register R6
        \item Immediate offset of 40, which is positive, U = 1
...
\section{Encode POP Instruction \hfill (5 Points)}

Encode the assembly instruction \texttt{POP \{R3, R8, R0\}} into machine code.
...
\section{Encode LDR Instruction \hfill (5 Points)}

Encode the assembly instruction \texttt{LDR R9, [R5, \#-32]} into machine code.
...
\begin{tcolorbox}[
    ...
    \begin{itemize}
        \item Load word into R9, L = 1, B = 0 (no Byte)
        \item Base register R5
        \item Immediate offset of -32, which is negative, U = 0
        \item No writeback, W = 0 (no pre-indexing)
        \item P = 1 (Offset)
        \item Immediate is there $\bar{I} = 0$
    \end{itemize}
